import{$ as e,$t as t,B as n,Bt as r,Ct as i,Ft as a,K as o,Kt as s,Lt as c,Nt as l,Q as u,Rt as d,St as f,V as p,Vt as m,W as h,Wt as g,Xt as _,at as v,cn as y,d as b,dt as x,et as S,fn as C,hn as w,ht as T,jt as E,l as D,nt as O,ot as k,q as A,rt as j,sn as M,st as N}from"./_plugin-vue_export-helper-xtfkLN2I.js";import{d as P,f as F,l as ee,o as te,s as I}from"./light-F9vJ8mix.js";import{f as ne,l as L,o as R,t as z,u as B}from"./Scrollbar-D45CVf5K.js";import{i as re,t as ie}from"./fade-in.cssr-DyPg4UAa.js";import{C as ae,D as oe,O as se,S as ce,T as le,a as ue,b as de,c as V,d as fe,g as pe,h as me,m as he,p as ge,r as _e,s as H,t as ve,u as ye,w as be,x as xe,y as Se}from"./light-CVx5NmoQ.js";import{t as Ce}from"./Button-CwpV6XVQ.js";import{B as we,I as U,L as Te,R as Ee,j as De,z as W}from"./index-Cxr_Uq9z.js";var G=y(null);function K(e){if(e.clientX>0||e.clientY>0)G.value={x:e.clientX,y:e.clientY};else{let{target:t}=e;if(t instanceof Element){let{left:e,top:n,width:r,height:i}=t.getBoundingClientRect();G.value=e>0||n>0?{x:e+r/2,y:n+i/2}:{x:0,y:0}}else G.value=null}}var q=0,Oe=!0;function ke(){if(!se)return M(y(null));q===0&&B(`click`,document,K,!0);let e=()=>{q+=1};return(Oe&&=oe())?(r(e),m(()=>{--q,q===0&&L(`click`,document,K,!0)})):e(),M(G)}var Ae=y(void 0),J=0;function je(){Ae.value=Date.now()}var Me=!0;function Ne(e){if(!se)return M(y(!1));let t=y(!1),n=null;function i(){n!==null&&window.clearTimeout(n)}function a(){i(),t.value=!0,n=window.setTimeout(()=>{t.value=!1},e)}J===0&&B(`click`,window,je,!0);let o=()=>{J+=1,B(`click`,window,a,!0)};return(Me&&=oe())?(r(o),m(()=>{--J,J===0&&L(`click`,window,je,!0),L(`click`,window,a,!0),i()})):o(),M(t)}var Y=S(`card-content`,`
 flex: 1;
 min-width: 0;

...
> 상태: 🔵 설계·초안 — Order/Dispatch/Settlement 확장을 위한 비즈니스 구조 설계
...
NoWhere는 기사와 기사 사이에서 운행을 등록하고 거래하는 플랫폼이다.

모든 기능은 "예약"이 아닌 "운행(Order)"를 중심으로 설계한다.
...
운영자가 운행을 빠르게 판단하고 거래할 수 있도록 구성한다.

...
const PAGE_LABEL = {
    ...
    more: '더보기', history: '운행 기록', reviews: '받은 리뷰', settlements: '정산 내역',
};
...
const showBack = computed(() => {
    ...
    return !['home', 'market', 'my-orders', 'community', 'profile', 'order-create', 'match', 'chat', 'more'].includes(route.name);
});
...
const showBell = computed(() => {
    ...
    return ['home', 'market', 'order-create', 'chat', 'community', 'profile', 'match', 'more'].includes(route.name);
});

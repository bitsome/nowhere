...
.chat-list__item:hover{border-color:rgba(54,173,255,.35);box-shadow:0 2px 8px rgba(0,0,0,.06)}

/* 안읽음 대화 강조 */
.chat-list__item--unread{border-color:rgba(54,173,255,.4);background:rgba(54,173,255,.04)}
.chat-list__item--unread:hover{border-color:rgba(54,173,255,.55)}
...
.chat-list__order-chip{flex-shrink:0;padding:1px 6px;border-radius:6px;background:rgba(54,173,255,.12);color:#36adff;font-size:11px;font-weight:700}
</style>

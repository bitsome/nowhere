    ...
    <section class="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside class="page-panel panel-gray lg:sticky lg:top-6 lg:self-start">
            ...
            <nav class="mt-4 space-y-2">
                ...
                <a href="{{ route('dashboard.business.boards.create') }}" class="flex items-center justify-between rounded-lg border border-[#cfcfcf] bg-[#ececec] px-3 py-2 text-sm text-[#1f1f1f] dark:border-[#343434] dark:bg-[#222222] dark:text-[#f3f3f3]" title="게시글 등록">
                    <span>게시글 등록</span>
        ...
        <div class="space-y-4">
            ...
            <section class="page-panel">
                <form method="POST" action="{{ route('dashboard.business.boards.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-6 flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('dashboard.business.boards') }}" class="btn-secondary" title="게시글 목록">취소</a>
                    </div>
                </form>
            </section>
        </div>

<x-layouts.app title="파일관리">
    <section class="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
        ...
        <div class="space-y-4">
            ...
            @include('dashboard.modules.files.partials.upload-panel')

            @include('dashboard.modules.files.partials.upload-list')

            @include('dashboard.modules.files.partials.manager-table')
        </div>
    </section>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const previewCard = (file, index) => {
                ...
                if (file.type.startsWith('image/')) {
                    preview.className = 'mt-2.5 h-[96px] w-full rounded-[10px] border border-[#dddddd] bg-[#f7f7f7] object-contain dark:border-[#2a2a2a] dark:bg-[#141414]';

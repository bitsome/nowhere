...
class OrderFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'vehicle_type' => fake()->randomElement(['카니발', '스타리아', '그랜저']),
            'service_type' => fake()->randomElement(['pickup', 'sending', 'landing']),
            'service_date' => now()->addDays(fake()->numberBetween(1, 7))->format('Y-m-d'),
            'service_time' => sprintf('%02d:%02d', fake()->numberBetween(6, 22), fake()->randomElement([0, 30])),
